...
def check_startup_requirements():
    ...
    if has_errors:
        ...
        if not env_exists or not token_found:
            ...
            print("   TELEGRAM_BOT_TOKEN=8968362369:AAH3wWvU67IJrrU3XLla7ITauBaZe-qJ5fc")
            print("   ADMIN_IDS=6978365881\n")
...
DEVELOPER_USERNAME = os.getenv('DEVELOPER_USERNAME', "@Donsaab2213")
...
def prompt_join_channels(chat_id):
    ...
    for idx, channel in enumerate(REQUIRED_CHANNELS, 1):
        ...
        try:
            ...
            url = f"https://t.me/Donsaab2213" # Fallback to developer
...
def send_welcome_dashboard(chat_id, message_id=None):
    ...
    markup = types.InlineKeyboardMarkup(row_width=2)
    btn_dev = types.InlineKeyboardButton("👨‍💻 Developer", url=f"https://t.me/{DEVELOPER_USERNAME.replace('@', '')}")
